...
public class AuthenticationService {
	...
	@Autowired
	public AuthenticationService(PasswordCryptographyProvider passwordCryptographyProvider, UserService userService, AuthTokenService authTokenService, UserRepository userRepository) {
