...
public class TimeSlot {
    ...
    public TimeSlot(String doctorId, String date) {
        ...
        int noOfOutput = (doctorId.hashCode() + date.hashCode()) % TimeSlotConstants.AVAILABLE_TIME_SLOTS.size() + 1;

        timeSlot = getRandomElement(new ArrayList<>(TimeSlotConstants.AVAILABLE_TIME_SLOTS), noOfOutput);
    }
